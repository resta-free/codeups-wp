    ...
    <div class="p-works-detail__inner">
      ...
      <div class="swiper p-works-detail__slider">
        <div class="swiper-wrapper">
          ...
          if ( has_post_thumbnail() ) {
            ...
            echo '<img loading="lazy" src="' . esc_url( get_template_directory_uri() ) . '/assets/img/common/noimg.png" alt="画像がありません">';
          }
        ?>
          </div>
          <div class="swiper-slide">
            <img loading="lazy" src="<?php echo get_template_directory_uri() ?>/assets/img/works/works-detail_img3.jpg" alt="スライダー画像">
          </div>
          <div class="swiper-slide">
            <img loading="lazy" src="<?php echo get_template_directory_uri() ?>/assets/img/works/works-detail_img4.jpg" alt="スライダー画像">
          </div>
          <div class="swiper-slide">
            <img loading="lazy" src="<?php echo get_template_directory_uri() ?>/assets/img/works/works-detail_img5.jpg" alt="スライダー画像">
          </div>
          <div class="swiper-slide">
            <img loading="lazy" src="<?php echo get_template_directory_uri() ?>/assets/img/works/works-detail_img6.jpg" alt="スライダー画像">
          </div>
          <div class="swiper-slide">
            <img loading="lazy" src="<?php echo get_template_directory_uri() ?>/assets/img/works/works-detail_img7.jpg" alt="スライダー画像">
          </div>
          <div class="swiper-slide">
            <img loading="lazy" src="<?php echo get_template_directory_uri() ?>/assets/img/works/works-detail_img8.jpg" alt="スライダー画像">
          </div>
          <div class="swiper-slide">
            <img loading="lazy" src="<?php echo get_template_directory_uri() ?>/assets/img/works/works-detail_img9.jpg" alt="スライダー画像">
          </div>
        </div>
      ...
      <dl class="p-works-detail__list">
        ...
        <div class="p-works-detail__box">
          <dt class="p-works-detail__term">おすすめポイント</dt>
