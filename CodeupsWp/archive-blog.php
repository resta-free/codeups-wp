  ...
  <section class="p-sub-blog">
    <div class="p-sub-blog__inner">
      ...
      <ul class="p-sub-blog__list">
        <li class="p-sub-blog__category is-active"><a href="<?php echo esc_url( get_post_type_archive_link( 'blog' ) ); ?>">ALL</a></li>
        <?php
        $language_terms = get_terms( 'language', array( 'hide_empty' => false ) );
        foreach ( $language_terms as $language_term ) :
      ?>
        <li class="p-sub-blog__category"><a href="<?php echo esc_url( get_term_link( $language_term, 'language' ) ); ?>"><?php echo esc_html( $language_term->name ); ?></a></li>
        <?php
        endforeach;
      ?>
      </ul>
